<x-admin.app-layout>
    ...
    <div class="card card-white">
        ...
        <form action="{{ url('/admin/sliders/update') }}" method="POST" enctype="multipart/form-data" id="slider_form">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                ...
                                <input type="text" name="title" id="title" class="form-control" value="{{old('intro',$slider->title)}}">
                                <input type="hidden" name="id" value="{{$slider->id}}">
                            </div>
                            <div class="form-group col-sm-12">
                                <label>Description<span class="text-danger">*</span></label>
                                <textarea name="description" id="description" rows="2" class="form-control">{{old('description',$slider->description)}}</textarea>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio"  id="disable" name="status" value="disable" {{$slider->status == "disable"?"checked": ""}}>
                                <label class="form-check-label" for="disable">Disable</label>
                                <input type="radio"  id="enable" name="status" value="enable" {{$slider->status == "enable"?"checked": ""}}>
        ...
        <x-slot name="footer">
            <script>
                ...
                {id: 1, src: "{{ asset('storage/images/sliders/'.$slider->image) }}"},
                ];  
