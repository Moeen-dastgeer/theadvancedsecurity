<x-admin.app-layout>
    ...
    <div class="card card-white">
        ...
        <form action="{{ route('admin.services.update') }}" method="POST" enctype="multipart/form-data" id="product_form">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label>Title<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="title" id="title" value="{{ old('name',$service->title) }}">
                ...
                <div class="form-group col-sm-12">
                    <label>Description<span class="text-danger">*</span></label><br>
                        <textarea id="long_desc" name="long_desc" class="form-control short_summernote" value="">{{ old('long_des',$service->description) }}</textarea>
                </div>
                <div class="form-group">
        ...
        <x-slot name="footer">
            <script>
               let main_image_preloaded = [
                {id: 1, src: "{{ asset('storage/images/services/'.$service->image) }}"},
                ];  
