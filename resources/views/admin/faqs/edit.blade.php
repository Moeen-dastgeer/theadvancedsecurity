<x-admin.app-layout>
    ...
    <div class="card card-white">
        ...
        <form action="{{ route('admin.web_settings.faqs.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label>Question<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="question" value="{{ old('question',$faq->question) }}">
                    <input type="hidden" class="form-control" name="id" value="{{ old('question',$faq->id) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="short_summernote" name="answer">{{ old('answer',$faq->answer) }}</textarea>
                    <span class="text-danger">
                        @error('answer')
                            {{ $message }}
                        @enderror
