                ...
                <div class="row row-cols-lg-4 row-cols-1 gy-5 xxs-link-single">
                    <div class="col">
                        <div class="footer-widget">
                            ...
                            <p>Welcome to Advance Security Company, your premier partner in safeguarding what matters most. With a relentless commitment to innovation and excellence, we provide tailored security solutions to meet your specific needs.</p>
                        </div>
                    </div>
                    <div class="col">
