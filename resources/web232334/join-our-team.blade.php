 ...
 <div class="full-row bg-light">
     <div class="container">
         <div class="row align-items-center">
             <div class="col-lg-5">
                 <img src="{{asset('web/assets/images/Security-12.png')}}" alt="">
             </div>
             <div class="col-lg-7">
                 <h3 class="down-line mb-3 fw-600">Security Guard Jobs Near YOU</h3>
                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto, nostrum a minus id consequuntur fugit corporis aspernatur repellendus error repudiandae omnis sed, culpa repellat asperiores explicabo aperiam. Blanditiis, est numquam?</p>
                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto, nostrum a minus id consequuntur fugit corporis aspernatur repellendus error repudiandae omnis sed, culpa repellat asperiores explicabo aperiam. Blanditiis, est numquam?</p>
             ...
             <div class="col">
                 <div class="w-80">
                     <h1 class="down-line-primary text-secondary mb-30 count wow animate__animated animate__fadeInUp"
                         data-wow-delay="400ms" data-wow-duration="900ms">Join us Our Team</h1>
                     <p>
                         We’re currently seeking candidates for full and part-time guard positions. Also seeking motivated sales
                         professionals
                         for full-time customer acquisition and relationship management.
                     </p>
                     <p>
                         Candidates should share our values, vision, tenacity and desire to provide unparalleled service to our clients.
                     </p>
                 </div>
             </div>
             <div class="col">
